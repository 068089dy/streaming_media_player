...
public class HeadPagerFragment1 extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void initdata(){
        ...
        StringRequest request = new StringRequest("http://capi.douyucdn.cn/api/v1/live/265?&limit=100",
