...
public class ClassifyPagerFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void initdata(){
        ...
        StringRequest request = new StringRequest("http://www.panda.tv/ajax_sort?token=&pageno=1&pagenum=120&classification=all&_=1492344568373",
    ...
    private void add_data(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(view.getContext());
        StringRequest request = new StringRequest("http://www.panda.tv/ajax_sort?token=&pageno="+add_data_num+"&pagenum=120&classification=all&_=1492344568373",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String s) {
                        try {
